...
<!--                                    <div class="search_close" onclick="$('body').click(); $(this).hide(); return false;"><i></i></div>-->
                                ...
                                <a class="fix-login btn small blue popup-open"
                                   href="en/registrationd56b.html?login"><span>Login</span></a>
                            </li>
                            <li class=""><a class="btn green_reg_top small popup-open"
                                   href="en/registration.html"><span>Join Now</span></a>
                            </li>
							                    </ul>
                </nav>
    ...
    <div class="our-games__slider">
        <ul class="bxslider" id="our-games__news_slider">
            ...
            <!-- tournament_slot_of_the_week-->
                ...
                >
                                            <a href="en/registrationd56b.html?login">
                    ...
                    <div class="tournament_desc">
                        <div class="tournament_bottom">
                            <p class="title_of_turnament">
                                <i class="iconn"></i>
                                <a href="en/tournament/tournament_slot_of_the_week.html" style="color: #ffffff;">
                                    Tournament                                    Fairy Tales Week                                </a>
                            </p>

                            <div class="text-center fix_width50">
                                <a class="btn green small" href="en/registrationd56b.html?login">
            ...
            <!-- pragmatic_argo_tournament-->
                ...
                >
                    ...
                    <div class="tournament_desc">
                        <div class="tournament_bottom">
                            <p class="title_of_turnament">
                                <i class="iconn"></i>
                                <a href="en/tournament/pragmatic_argo_tournament.html" style="color: #ffffff;">
                ...
                <li class="our-games__item  ">
                    ...
                    <div class="our-games__photo">
						...
						<img loading="lazy" class="provider" src="img/providers/boxicons/red_tiger.png" />                        <!-- red_tiger-->
                        <div class="sepia">
                            <ul>
                                <li>
                    ...
                    <div class="our-games__photo">
						...
						<img loading="lazy" class="provider" src="img/providers/boxicons/big_time_gaming.png" />                        <!-- big_time_gaming-->
                        <div class="sepia">
                            <ul>
                                <li>
									Lil Devil                                </li>
                    ...
                    <div class="our-games__photo">
                        <img loading="lazy" width="190" height="122"
                             src="../d32wwkuryjkg7f.cloudfront.net/img/15e57df46cbec8.jpg" alt="microgaming">
						<img loading="lazy" class="provider" src="img/providers/boxicons/microgaming.png" />                        <!-- microgaming-->
                        <div class="sepia">
                            <ul>
                                <li>
...
<section class="text middle Complaints about_box">
<!--    Microgaming, Thunderkick, Pragmatic Play, 1x2 Gaming, Amaya Branded DC Comics/Amaya GDM, Elk Studios, Lightning Box, Amanet, NextGen Gaming, NetEnt, Igaming2Go, Casino Technology, Bet Digital, Endorphina-->
<div class="trans">       <h2 class="rulles title2">ArgoCasino – online casino </h2>       <p> Online casino – is not only interactivity and accessibility, but this is also an advanced possibility, related to players’ content. ArgoCasino follows the current tendencies and renews the list of the Games adding new enhanced versions. As a result, users can use a unique resource which fulfills the newest demands of a player. The unique online Slots, which bring the user to an unforgettable world led by luck - are capable to amaze even the most selective visitor of the website due to their variety. It is evident even after spending only a few minutes on our online casino website. Because only here players can find wonderful graphics, a huge amount of gaming stories and generous payouts. </p></div>     <div><h4 class="rulles title2">Why is worth to play at ArgoCasino?</h4>       <p>Our online casino takes care about the security of the user audience, that is why each player of our resource can rely on absolute confidentiality of his personal information, as well as the security of his own account. In case any questions arise or there are some misunderstandings, there is a round-the-clock customer support service available, the staff of which continuously without breaks or weekends, communicates with clients, helping them clear out any concerns and proposing them it’s qualified assistance. A significant advantage will be the ability to quickly withdraw the winnings. In this case, our casino has several ways to withdraw funds, so that the player can choose the most convenient payment system for him. The same applies to replenish the player's personal account. Our online casino is developing at an amazing rate. Thus, players will be able to find here the best slots they could ever imagine, dive into roulette world or risk in virtual poker. Modern graphics, design and exciting gameplay will be a real surprise even for the experienced fans of games of this kind. Besides the real money mode, you can risk using you game credits in the demo mode. The last one is designed to help familiarize with the gameplay itself, with the rules of the game, the basic principles of the game, as well as, just play for interest. All gaming machines are also available in downloadable applications - for desktops running OS Windows and mobile handheld devices running Android OS. In order to become a full-fledged user of Argo Casinos, it is recommended to pass a simple registration process. Correctly specifying personal data, the player will receive an excellent protected account, allowing to play on the resource in full pleasure. In order to maximally secure themselves and their financial means, it is strictly forbidden to communicate their login and password to any third parties.</p></div>     <div><h4 class="rulles title2">The new generation of gaming machines at ArgoCasino.</h4>       <p>The updated online casino ArgoCasinos offers its users a new level of entertainment - now all slot machines can be played online. The very number of gaming machines and their manufacturers is significantly expanded. Now, for the gameplay are available such hits from Microgaming, Thunderkick, Pragmatic Play, 1x2 Gaming, Amaya Branded DC Comics/Amaya GDM, Elk Studios, Lightning Box, Amanet, NextGen Gaming, NetEnt, Igaming2Go, Casino Technology, Bet Digital, Endorphina. Also, new items are waiting for you in the sections of desktop and card games - this, for example, is the most popular among fans of excitement Black Jack, Baccarat, Three Card Poker and much more. Classic American and European roulettes are available for playing on the site without downloading.</p></div>     <div><h4 class="rulles title2">Online casino - an excellent choice for exciting leisure</h4>       <p>Being one of the best online casinos in Peru, we do not cease to amaze users of any level. ArgoCasino team works tirelessly to update all aspects of the project, permanently improving the design, taking care of the game variety, offering more and more options of bonuses and promotions. The bonus policy of casino ArgoCasino is designed to generously encourage both newcomers and loyal customers. Players can use a variety of bonuses that are constantly updated, and to win with their help even more. ArgoCasino is an excellent resource for entertainment at any time and in any place, so not only slot lovers can definitely try it out in practice.</p>     </div>     <div><h4 class="rulles title2">Bonuses at ArgoCasino</h4>       <p>Rarely does anyone give up gifts! There is a welcome bonus for each registered guest. This is an impressive amount that will help you make the first steps in mastering your favorite game, teach a beginner to be circumspect, and will give an opportunity later to confidently play already on their own money. But the casino does not limit on one gift only! Bonus policy of the institution provides an extensive program, which includes other types of incentives, promotions, tournaments, and cash games.</p></div>     <div><h4 class="rulles title2">Play Online Casino</h4>       <p>All disputable or incomprehensible situations become clear online, for your communication with the administration, there is a chat. The security of accounts and personal data - under the control of proven programs, and in general, it's time to forget about the old "scarecrows", modern online casinos, licensed and legitimate, provide all the conditions for an active and protected game in the best world traditions.</p></div>    <a href="#" id="loadMore" class="hide">Show more</a>
    <a href="#" id="collapse" class="">hide</a>
...
<script type="text/javascript" src="en/dassets/translated434?v=229038ae1ccd3438dfd84d404933723c"></script>
...
<script type="text/javascript" src="en/dassets/gamesjsond434?v=229038ae1ccd3438dfd84d404933723c"></script>
<script>
    $(function() {
