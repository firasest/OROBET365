...
public function ajouter(){ 
  ...
  include('../includes/connect_db.php');
      ...
      $req = $bdd->exec ("INSERT INTO `basketball`(`champion`,`eq1`, `eq2`, `date`,`temp`, `resultateq1`, `resultateq2`) 
    ...
    $req=$bdd->exec("UPDATE `basketball` 
...
public function supprimer(){ 
    ...
    $req = $bdd->exec('DELETE FROM `basketball` WHERE id=\''.$_tempET['id'].'\''); 
