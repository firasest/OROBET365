...
public function ajouter(){ 
  ...
  include('../includes/connect_db.php');
      ...
      $req = $bdd->exec ("INSERT INTO `volleyball`(`champion`,`eq1`, `eq2`, `date`,`temp`, `resultateq1`, `resultateq2`) 
    ...
    $req=$bdd->exec("UPDATE `volleyball` 
...
public function supprimer(){ 
    ...
    $req = $bdd->exec('DELETE FROM `volleyball` WHERE id=\''.$_GET['id'].'\''); 
