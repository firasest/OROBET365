                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Listes Client</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">orobet365</a></li>
                                            <li class="breadcrumb-item active">Listes Client</li>
                                        </ol>
                                    </div>
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <td><?php echo $donnees['surname']; ?></td>
        <td><?php echo $donnees['password']; ?></td>
        <td><?php echo $donnees['phone']; ?></td>
        <td><?php echo $donnees['bonus']; ?></td>
        <td><?php echo $donnees['balance']; ?></td>
        <td>
