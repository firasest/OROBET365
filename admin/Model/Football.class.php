...
public function ajouter(){ 
  ...
  include('../includes/connect_db.php');
      ...
      $req = $bdd->exec ("INSERT INTO `football`(`champion`,`eq1`, `eq2`, `date`,`temp`, `resultateq1`, `resultateq2`) 
...
public function supprimer(){ 
    ...
    $req = $bdd->exec('DELETE FROM `football` WHERE id=\''.$_GET['id'].'\''); 
