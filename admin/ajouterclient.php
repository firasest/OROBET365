...
<head>
        ...
        <meta content="Premium Multipurpose football & Dashboard phonelate" name="description" />
        <meta content="Themesbrand" name="author" />
        <!-- App favicon -->
        <link rel="shortcut icon" href="assets/images/favicon.ico">

        <link href="assets/libs/bootstrap-passwordpicker/css/bootstrap-passwordpicker.min.css" rel="stylesheet">
    ...
    <body data-sidebar="dark">
        ...
        <div id="layout-wrapper">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Ajouter client </h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="Controller/ajouter_client.php" method="post">
            ...
            <div class="form-group">
                ...
                placeholder="Saisissez votre Surname" >
            </div>
            ...
            <div class="form-group">
                ...
                placeholder="Saisissez votre phone" >        
            </div>
            <div class="form-group">
                <label for="bonus">Bouns</label>
                <input type="number" class="form-control" id="bonus" name="bonus" 
                placeholder="Saisissez votre Bounes" >        
            </div>
            <div class="form-group">
        ...
        <!-- bootstrap passwordpicker -->
        <script src="assets/libs/bootstrap-passwordpicker/js/bootstrap-passwordpicker.min.js"></script>
