...
<head>
        <meta charset="utf-8" />
        <title>Ajouter basketball </title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Premium Multipurpose basketball& Dashboard Template" name="description" />
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Ajouter basketball</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">OROBET</a></li>
                                            <li class="breadcrumb-item active">Ajouter basketball</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Ajouter basketball</h4>
                                        
                                        

		
                                        <form action="Controller/ajouter_basketball.php" method="post">
                     
									
            
             <div class="form-group">
                <select name="champion" required>
                <option value="" selected>selection votre Champion</option>
                 <option value="ENGLAND INTERNATIONAL LEAGUE">ENGLAND INTERNATIONAL LEAGUE</option>   
                </select>
            </div>                         
                                        
            <div class="form-group">
                <label for="eq1">Equipe 1</label>
                <input type="text" class="form-control" id="eq1"  name="eq1" 
                placeholder="Saisissez votre Equipe 1"  required>
            </div>

            <div class="form-group">
                <label for="eq2">Equipe 2</label>
                <input type="text" class="form-control" id="eq2"  name="eq2" 
                placeholder="Saisissez votre Equipe 2" required>
            </div>
