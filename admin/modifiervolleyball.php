...
$id= $_GET['id'];
$req = $bdd->query("SELECT * FROM volleyball WHERE id=$id");
$donnees = $req->fetch();
 ?>
  <?php
session_start();
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">modifier VolleyBall</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">orobet365</a></li>
                                            <li class="breadcrumb-item active">modifier VolleyBall</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">modifier volleyball</h4>
                                        
                                        

		
                                        <form action="Controller/modifier_volleyball.php?id=<?php echo $donnees['id']; ?>" method="post">
